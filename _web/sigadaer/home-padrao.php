		...
		<tr>
			<td valign="top">
				<table class="table table-striped table-dark table-bg" style="border-radius: 0px !important;">
					...
					<tbody>
						<?php
							$sql = "SELECT historico_pendentes.div_sigla, doc_pendentes.div_nome, historico_pendentes.qtd_pendentes, historico_pendentes.data FROM historico_pendentes INNER JOIN doc_pendentes ON historico_pendentes.div_sigla=doc_pendentes.div_sigla  WHERE data='2024-03-01' ORDER BY qtd_pendentes DESC";
				...
				echo "<table class='table table-striped table-secondary table-dark'>";
					...
					echo "<tbody>";
							...
							while($cont3 < 95){
								...
								$hist_sigla = "SELECT * FROM historico_pendentes  WHERE data='2024-03-08' AND div_sigla='$array[$cont3]'";
